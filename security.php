...
<div class=\"body_padded\">
	...
	<form action=\"#\" method=\"POST\">
		...
		<ol>
			<li> Low - This security level is completely vulnerable and <em>has no security measures at all</em>. It's use is to be as an example of how web application vulnerabilities manifest through bad coding practices and to servei info@danielmaldonado.com.ar as a platform to teach or learn basic exploitation techniques.</li>
